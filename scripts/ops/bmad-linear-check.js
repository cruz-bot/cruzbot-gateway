#!/usr/bin/env node
/**
 * bmad-linear-check.js ΓÇö BMAD ΓåÆ Linear Auto-Sync (CRU-89)
 *
...
// ΓöÇΓöÇ Config ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Argument parsing ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Manifest helpers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function loadManifest() {
  ...
  try {
    ...
    console.warn(`ΓÜá∩╕Å  Could not parse manifest ΓÇö starting fresh: ${err.message}`);
    return { version: 1, entries: [] };
  }
}
...
// ΓöÇΓöÇ Story scanning ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
/** Normalise Windows backslashes ΓåÆ forward slashes for consistent keys. */
function normalizePath(p) {
  return p.replace(/\\/g, '/');
}

// ΓöÇΓöÇ Linear sync ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function syncStory(relPath) {
  ...
  try {
    ...
    // Parse issueIdentifier from stdout (e.g. "Γ£à Created CRU-123:")
...
// ΓöÇΓöÇ Main ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

function main() {
  console.log(`\n≡ƒöä BMAD ΓåÆ Linear Auto-Sync${DRY_RUN ? ' [DRY RUN]' : ''}`);
  ...
  console.log(`≡ƒôé Found ${allStories.length} story file(s) total`);

  // 3. Gap detection
  const unsynced = allStories.filter(p => !alreadySynced.has(p));
  const syncedCount = allStories.length - unsynced.length;

  console.log(`Γ£à Already synced : ${syncedCount}`);
  console.log(`ΓÜá∩╕Å  Unsynced      : ${unsynced.length}\n`);

  if (unsynced.length === 0) {
    console.log('≡ƒÄë All stories are synced. Nothing to do.');
    return;
  }

  // 4. Report or sync
  if (DRY_RUN) {
    console.log('≡ƒôï Would sync the following stories:');
    for (const story of unsynced) {
      console.log(`   ΓÇó ${story}`);
    }
  ...
  for (const relPath of unsynced) {
    ...
    if (result.success) {
      ...
      console.log(`Γ£à ${result.issueIdentifier}`);
      successCount++;
    } else {
      console.log(`ΓÜá∩╕Å  WARN: ${result.error}`);
      failCount++;
    }
  }

  console.log(`\n≡ƒôè Sync complete: ${successCount} created, ${failCount} failed`);
  if (failCount > 0) {
    console.log(`   ΓÜá∩╕Å  Failures are non-fatal. Re-run to retry failed stories.`);
  }
  console.log(`   ≡ƒôä Manifest: ${MANIFEST_PATH}`);
}

// Always exit 0 ΓÇö errors are warnings, never block the heartbeat
try {
  main();
} catch (err) {
  console.error(`ΓÜá∩╕Å  Unexpected error in bmad-linear-check: ${err.message}`);
